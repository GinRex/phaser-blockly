...
export default class platformMove extends Phaser.GameObjects.Sprite {
  constructor(config) {
...
if (!(this.moveLeft) && ((this).x) < (this.scene.cameraWidth) - 50) {
  Motion.foward( this, 3);
  (this).body.updateFromGameObject();
  if (((this).x) >= (this.scene.cameraWidth) - 50) {
    this.moveLeft = true;
  }
}
if ((this.moveLeft) && ((this).x) > 50) {
  Motion.foward( this, -3);
  (this).body.updateFromGameObject();
  if (((this).x) <= 50) {
    this.moveLeft = false;
